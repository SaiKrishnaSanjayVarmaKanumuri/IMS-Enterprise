    ...
    async (req: Request, res: Response): Promise<void> => {
        try {
            ...
            logAudit(
                ...
                "roles",
                role.id,
                { name: role.name, permissionCount: permissions.length },
                "success",
            );

            logger.info(
                `Role ${role.name} created by admin ${adminUser.email}`,
            );
    ...
    async (req: Request, res: Response): Promise<void> => {
        try {
            ...
            logAudit(
                ...
                "roles",
                id,
                { name: role.name, changes: updateData },
                "success",
            );

            logger.info(
                `Role ${role.name} updated by admin ${adminUser.email}`,
            );
...
router.delete(
    ...
    async (req: Request, res: Response): Promise<void> => {
        try {
            ...
            logger.info(
                `Role ${role.name} deleted by admin ${adminUser.email}`,
            );
