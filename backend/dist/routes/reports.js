...
router.get("/inventory/csv", auth_js_1.authenticate, async (req, res) => {
    try {
...
router.get("/purchase-orders/csv", auth_js_1.authenticate, async (req, res) => {
    try {
...
router.get("/purchase-orders/:id/pdf", auth_js_1.authenticate, async (req, res) => {
    try {
...
// ─── Export Requests CSV ─────────────────────────────────────────────
router.get("/requests/csv", auth_js_1.authenticate, async (req, res) => {
    try {
        const { siteId, status } = req.query;
        const where = {};
        if (siteId)
...
router.get("/audit-logs/csv", auth_js_1.authenticate, async (req, res) => {
    try {
